...
enum class MainPanelType(var id: Int, var description: Int, var icon: Int, var buttonText: Int, var image: Int) {
    ...
    START_STUDY(3, R.string.patient_start_study, R.drawable.ic_logo_secondary, R.string.start_study, R.drawable.bg_register_panel),
    START_STUDY_WITH_NAME(4, R.string.patient_start_study_with_name, R.drawable.ic_logo_secondary, R.string.start_study, R.drawable.bg_register_panel),
