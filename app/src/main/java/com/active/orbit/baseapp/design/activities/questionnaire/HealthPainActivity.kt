...
class HealthPainActivity : BaseActivity(), View.OnClickListener {
    private lateinit var binding: ActivityHealthPainBinding
        ...
        when (v) {
            ...
            binding.btnNext -> {
                ...
                if (isSelectionValid()) {
                    ...
                    bundle.putString(Extra.HEALTH_PAIN.key, response)
                    Router.getInstance().activityAnimation(ActivityAnimation.LEFT_RIGHT).startBaseActivityForResult(this, Activities.HEALTH_ANXIETY, bundle, HealthActivity.HEALTH_REQUEST_CODE)
                } else {
