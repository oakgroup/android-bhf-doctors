...
class FaqProvider private constructor(private val context: Context) {
    ...
    private fun initialize() {
        ...
        val category1sub4Response = FaqModel(category1sub3.category, context.resources.getString(R.string.faq_answers_4))
        val category1sub5Response = FaqModel(category1sub3.category, context.resources.getString(R.string.faq_answers_5))
        val category1sub6Response = FaqModel(category1sub3.category, context.resources.getString(R.string.faq_answers_6))
        val category1sub7Response = FaqModel(category1sub3.category, context.resources.getString(R.string.faq_answers_7))
        val category1sub8Response = FaqModel(category1sub3.category, context.resources.getString(R.string.faq_answers_8))
        val category1sub9Response = FaqModel(category1sub3.category, context.resources.getString(R.string.faq_answers_9))
