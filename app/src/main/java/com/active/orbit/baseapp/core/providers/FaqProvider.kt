...
class FaqProvider private constructor(private val context: Context) {
    ...
    private fun initialize() {
        ...
        val category1sub3 = FaqModel(context.resources.getString(R.string.faq_questions_general_4))
        ...
        val category1sub3Response = FaqModel(category1sub3.category, context.resources.getString(R.string.faq_answers_4))
        ...
        category2sub1.position = 7
        category2sub2.position = 8
        category2sub3.position = 9
        category3sub1.position = 10
        category3sub2.position = 11
        category1sub1Response.position = 12
        category1sub2Response.position = 13
        category1sub3Response.position = 14
        category2sub1Response.position = 15
        category2sub2Response.position = 16
        category2sub3Response.position = 17
        category3sub1Response.position = 18
        category3sub2Response.position = 19
